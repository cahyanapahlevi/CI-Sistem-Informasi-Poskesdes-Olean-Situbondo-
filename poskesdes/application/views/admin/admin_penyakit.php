...
<div class="container-fluid text-left">    
  <div class="row content">
    <div class="col-sm-2 sidenav">
      ...
      <div><a class="active" href="<?php echo base_url("admin/penyakit")?>"><i class="fa fa-heartbeat"></i> Data penyakit</a></div>
  ...
  <div class="panel-body" style="background-color: #27ae60;"><i class="fa fa-heartbeat" style="font-size:48px;color:white"></i> Data Penyakit<br><br>
