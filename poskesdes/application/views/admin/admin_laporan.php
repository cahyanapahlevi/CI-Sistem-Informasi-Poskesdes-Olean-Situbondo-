...
<div class="container-fluid text-left">    
  <div class="row content">
    <div class="col-sm-2 sidenav">
      ...
      <div><a class="active" href="<?php echo base_url("admin/laporan")?>"><i class="fa fa-sticky-note-o"></i> laporan</a></div>
    </div>
    </div>
  ...
  <div class="panel-body" style="background-color: #27ae60;"><i class="fa fa-sticky-note-o" style="font-size:48px;color:white"></i> Laporan<br>
