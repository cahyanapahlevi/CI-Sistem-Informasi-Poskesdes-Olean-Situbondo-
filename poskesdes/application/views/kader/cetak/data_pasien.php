...
<body>
    ...
    <tr> 
      ...
      <td width="85%"><div align="center" class="style1"><strong>Dinas Kelurahan Olean <br>
...
Jl Olean NO 1 kecamatan situbondo kabupaten situbondo </div></td>
    ...
    <tr>
      <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td colspan="2"><div align="center" class="style1"><strong>Data Pasien </strong><br>
          <?php echo "Kelurahan Olean " . date("j F Y "); ?>
        </div></td>
        </tr>
        <tr>
