 ...
 ?>
    <tbody>
      <tr>
                ...
                <td><?php
   if ($u->namarumahsakit_pasien == "rs_umum"){
echo 
   anchor('bidan/cetak1/'. $u -> id_pasien,'cetak', array('target' => '_blank'));
   }else if ($u->namarumahsakit_pasien == "rs_elizabeth"){ 
echo 
  anchor('bidan/cetak1/'. $u -> id_pasien,'cetak' , array('target' => '_blank'));
   }else{
echo 
  anchor('bidan/cetak2/'. $u -> id_pasien,'cetak', array('target' => '_blank'));
 }?></td>
            </tr>
            </tbody>
            <?php
