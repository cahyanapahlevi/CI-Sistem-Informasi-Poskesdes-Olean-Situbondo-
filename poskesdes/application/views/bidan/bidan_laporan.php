    ...
    <div class="col-sm-2">
      <div class="content3">
        <div class="icon-bar">
          ...
          <div> <a class="active" href="<?php echo base_url("bidan/laporan")?>"><i class="fa fa-envelope" style="float: left;"></i>&nbsp; Laporan</a></div>
        </div>
      </div>
    </div>
    <div class="col-sm-10">
      <div class="content4">
            <h1 style="text-align: center;">Detail Pasien</h1>
            <table align="center">
    <tr>
        <td> <?php echo anchor('bidan/cetaklaporan',' <span class="glyphicon glyphicon-print"></span> versi cetak', array('target' => '_blank')); ?></button></td>
    </tr>
</table>
        <div class="container">
            ...
            <table id="myTable" class="table table-hover">
              ...
              <tbody>
                <tr>
                  ...
                  <td><?php echo anchor('bidan/biodata/'. $u -> id_pasien,'keterangan', array('target' => '_blank'));?></td>
                </tr>
              </tbody>
                <?php }} ?>
            </table>
